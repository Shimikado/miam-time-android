...
import redant.litiere.miamtime.model.FoodCard
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val mSwipeView = findViewById<View>(R.id.swipeView) as SwipePlaceHolderView
        ...
        for (profile in Utils.loadProfiles(this.applicationContext)!!) {
            mSwipeView.addView(FoodCard(mContext, profile, mSwipeView))
        }
